    ...
    <nav>
      ...
      <div class="derechosAutor">
        <span class="pr-25 referenciaImagenesTexto">
          ...
          <span class="referenciaImagenesTexto"> (27 Mar, 2020)</span>
        </span>
      </div>
        ...
        <div class="col-eighty">
              ...
              <div class="row flex-alig-center ta-left">
                ...
                <div class="col-balance order-tab-1 ta-center">
                  ...
                  <span class="referenciaImagenesTexto">
                    ...
                    <span class="referenciaImagenesTexto">(21 Abr, 2026)</span>
                  </span>
                </div>
              </div>
            </div>
              ...
              <div class="row flex-alig-center ta-left">
                <div class="col-balance ta-center">
                  ...
                  <span class="referenciaImagenesTexto">
                    ...
                    <span class="referenciaImagenesTexto">(31 Ago, 2022)</span>
                  </span>
                </div>
              ...
              <div class="row flex-alig-center ta-left">
                ...
                <div class="col-balance order-tab-1 ta-center">
                  ...
                  <span class="referenciaImagenesTexto">
                    ...
                    <span class="referenciaImagenesTexto">(21 Ene, 2016)</span>
                  </span>
                </div>
              </div>
            </div>
            ...
            <div>
              <div class="row flex-alig-center ta-left">
                <div class="col-balance ta-center">
                  ...
                  <span class="referenciaImagenesTexto">
                    <span data-i18n="derechos_imagen_singular">Imagen tomada de </span>
                    <a href="https://www.despedidasdesolterologrono.es/actividades-despedidas-soltero-logrono/vino/cata-vino-en-logrono-menu-riojano/" class="fc-secondary fc-blue" target="_blank">Despedidas de soltero Logroño </a> <span class="referenciaImagenesTexto" data-i18n="derechos_imagen_sin_fecha">(Sin fecha)</span>
                  </span>
                </div>
                <div class="col-balance"> <span class="fc-primary fs-h3"
              ...
              <div class="row flex-alig-center ta-left">
                ...
                <div class="col-balance order-tab-1 ta-center">
                  ...
                  <span class="referenciaImagenesTexto">
                    ...
                    <span class="referenciaImagenesTexto">(Jun, 2021)</span>
                  </span>
                </div>
              </div>
            </div>
            ...
            <div>
              <div class="row flex-alig-center ta-left">
                <div class="col-balance ta-center">
                  ...
                  <span class="referenciaImagenesTexto">
                    <span data-i18n="derechos_imagen_singular">Imagen tomada de </span>
                    <a href="https://www.lavozdegalicia.es/noticia/lemos/2015/10/17/exigencias-consorcio-sobre-terrazas-afectaran-casco-viejo/0003_201510M17C19911.htm" class="fc-secondary fc-blue" target="_blank">La Voz de Galicia </a> <span class="referenciaImagenesTexto">(17 Oct, 2015)</span>
                  </span>
                </div>
                <div class="col-balance"><span class="fc-primary fs-h3"
          ...
          <div class="subscribe bg-primary-foot"
            ...
            <div class="contained row ta-center">
              ...
              <div class="col-full">
                <form name="index-suscribe" class="message-form-suscribe" onSubmit="enviarSuscripcion();" action="#">
                  ...
                  <button type="submit" class="btn-suscripcion btn-bg2 border-round"
                    data-i18n="suscripcion_boton"> Suscríbete </button>
                </form>
              </div>
            </div>
          </div>
