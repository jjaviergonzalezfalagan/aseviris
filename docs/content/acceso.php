    ...
    <nav>
      ...
      <div class="derechosAutor">
        <span class="pr-25 referenciaImagenesTexto">
          ...
          <a href="https://pixabay.com/es/photos/uva-uvas-tros-racimo-de-uvas-3606275/" class="fc-secondary fc-blue" target="_blank">
            <span data-i18n="derechos_imagen_pixabay_parrafo_2">Pixabay</span></a>
        </span>
      </div>
