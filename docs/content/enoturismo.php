    ...
    <nav>
      ...
      <div class="derechosAutor">
        <span class="pr-25 referenciaImagenesTexto">
          ...
          <a href="https://senda.pilgrim.es/camino-santiago-frances-enogastronomico/ribeira-sacra/" class="fc-secondary fc-blue" target="_blank">Senda By Pilgrim </a> <span class="referenciaImagenesTexto" data-i18n="derechos_imagen_sin_fecha">(Sin fecha)</span>
        </span>
      </div>
      <div class="contained">
    ...
    <section class="contained">
      ...
      <div class="col-full ta-left">
        ...
        <div class="col-wide flo-left ta-center">
          <h2 class="fc-primary fs-h2-intro ta-left" data-i18n="pgEnoturismo_seccion_enoturismo_titulo_video">
            Ribeira Sacra -Ruta del Vino- </h2>
          <video width="640" height="360" controls>
            <source src="../video/ruta_del_vino_ribeira_sacra.webm">
          </video>
          <div class="pt-7 ta-center">
            <a class="fs-minor" href="../video/ruta_del_vino_ribeira_sacra.mp4" target="_blank">
        ...
        <div class="col-slim flo-left">
          <p class="ta-left mlmr-a mt-50"><span data-i18n="pgEnoturismo_seccion_enoturismo_parrafo_1">
