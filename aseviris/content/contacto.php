      ...
      <div class="row">
        ...
        <div class="col-balance"> <span class="fs-h4 mb-15 mt-25 fc-primary" data-i18n="pgContacto_seccion_datos_encuentranos_titulo">Encuéntranos</span>
          ...
          <a id="email" href="#" class="display-inblock">
            ...
            <span data-i18n="pgContacto_seccion_datos_contactanos_texto_1">info@aseviris.ddns.net</span>
          </a>
          &nbsp;
          ...
          <form name="contacto" class="message-form mt-50 mb-25" action="../app/enviaMensaje.inc.php" method="post">
            ...
            <div class="row mb-20 broken-float">
              <input type="text" id="message-nombre" name="message-nombre" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" minlength="2" maxlength="25"
                title="Se admiten nombres de 2 a 25 caracteres." autocomplete="off" required>
              <input type="text" class="ml-a" id="message-apellidos" name="message-apellidos" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" minlength="2"
                maxlength="50" title="Se admiten apellidos de 2 a 50 caracteres." autocomplete="off" required>
            </div>
            <div>
              <label for="message-email" class="message-form-label-left" data-i18n="pgContacto_seccion_datos_mensaje_correo">Direccion de Correo electrónico:</label>
            ...
            <div class="row mb-20 broken-float">
              <input type="email" id="message-email" name="message-email" pattern="[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*@[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,5}"
                title="Se admiten direcciones de correo válidas con el formato: 'texto@texto.dominio'."
                autocomplete="off" required>
              <input type="tel" class="ml-a" id="message-telefono" name="message-telefono" pattern="^\d{9}$" maxlength="9"
            ...
            <input type="text" id="message-asunto" name="message-asunto" class="mb-20 broken-float" pattern="[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ.¿?¡!\s]+"
            ...
            <textarea id="message-mensaje" name="message-mensaje" class="broken-float" rows="5" minlength="5" maxlength="500"
              title="Se admiten textos de 5 a 500 caracteres." autocomplete="off" required></textarea>
            <button type="submit" class="btn-bg1 border-round mt-20" name="message-enviar" data-i18n="boton_enviar_mensaje">Enviar mensaje</button>
          </form>
        </div>
      </div>
    </section>
