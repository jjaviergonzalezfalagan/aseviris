  ...
  <main>
    ...
    <nav>
      ...
      <div class="derechosAutor">
        <span class="pr-25 pt-2 fs-derechosAutor">
          <a href="https://www.flickr.com/photos/22625483@N04/" class="fc-secondary fc-blue" target="_blank">Ramon Piñeiro</a>. 
          <a href="https://es.wikipedia.org/wiki/Archivo:Doade,_Sober,_Galiza.jpg" class="fc-secondary fc-blue fs-italic" target="_blank">Doade, Sober, Galiza </a>
          (2011). Licencia
          <a href="https://creativecommons.org/licenses/by-sa/2.0/deed.es" class="fc-secondary fc-blue" target="_blank">Atribución-CompartirIgual 2.0 Genérica </a>
          de Creative Commons.
        </span>
      </div>
      <div class="contained">
    ...
    <section class="contained">
      ...
      <div class="flo-left col-balance mt-50 ta-center">
        <img src="../images/gasparrocha-top-5078614_1920.jpg" alt="Los viñedos, Vino y Uvas">
        <br />

        <!-- Derechos de autor -->
        <span class="fs-derechosAutor">
          <a href="https://pixabay.com/es/users/gasparrocha-273037/" class="fc-secondary fc-blue" target="_blank">GasparRocha</a>. 
          <a href="https://pixabay.com/es/photos/los-vi%c3%b1edos-vino-uvas-vi%c3%b1edos-5078614/" class="fc-secondary fc-blue fs-italic" target="_blank">Los viñedos, Vino y Uvas</a>
           (2020). Licencia
